...
const check_policies_decorator_js_1 = require("../decorators/check-policies.decorator.js");
let PoliciesGuard = class PoliciesGuard {
    ...
    async canActivate(context) {
        const policyHandlers = this.reflector.get(check_policies_decorator_js_1.CHECK_POLICIES_KEY, context.getHandler()) || [];
        ...
        const isAllowed = policyHandlers.every((handler) => this.execPolicyHandler(handler, ability));
        if (!isAllowed) {
